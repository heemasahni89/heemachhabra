...
GENERIC_CAPTION = "Selected interior composition"
...
def patch_html(path):
    ...
    for old in ["Paris 16ème, France", "Paris 7ème, France", "Paris, France", "Brussels, Belgium", "Uccle, Belgique", "Ramatuelle, France", "Biarritz, France"]:
