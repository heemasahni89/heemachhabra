...
def patch_html(path):
    ...
    text = text.replace("<h2 class=\"tw-font-times-lt tw-text-2xl tw-text-white\">\n      HEEMA <span class=\"tw-font-grotesk-bd\">SAHNI CHHABRA</span> DESIGN\n    </h2>", "<h1 class=\"tw-font-times-lt tw-text-2xl tw-text-white\">\n      HEEMA <span class=\"tw-font-grotesk-bd\">CHHABRA</span> DESIGN CONSULTANT\n    </h1>")
    text = text.replace("<h2 class=\"tw-font-times-lt tw-text-2xl tw-text-white\">HEEMA <span class=\"tw-font-grotesk-bd\">SAHNI CHHABRA</span> DESIGN</h2>", "<h1 class=\"tw-font-times-lt tw-text-2xl tw-text-white\">HEEMA <span class=\"tw-font-grotesk-bd\">CHHABRA</span> DESIGN CONSULTANT</h1>")
    text = re.sub(r'<h2(?P<attrs>[^>]*)>\s*HEEMA\s*<span class="tw-font-grotesk-bd">CHHABRA</span> DESIGN CONSULTANT\s*</h1>', r'<h1\g<attrs>>\n      HEEMA <span class="tw-font-grotesk-bd">CHHABRA</span> DESIGN CONSULTANT\n    </h1>', text, count=1)
